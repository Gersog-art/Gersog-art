...
|--------|----------|--------|
| 🗡️[**Orchid v1**](https://github.com/Gersog-art/orchid) | Первый инструмент для анализа веб-уязвимостей | 🔨 В разработке |
| 🗡️ **Orchid v2** | Улучшенная версия с новым функционалом | 🔨 В разработке |
| 🚀 **Скоро...** | Новые инструменты для безопасности | ⏳ В планах |
| 🗡️ **Marci** | голосовой помощник на пк | 🔨 В разработке |
...
![Linux](https://img.shields.io/badge/Linux-020617?style=for-the-badge&logo=linux&logoColor=FFFFFF)
...
[![Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/white_gersog)
