<!--
    In the silence of the northern night, code flows like snowflakes.
    Each vulnerability is a hidden path through the ice.
-->
...
[![GitHub](https://img.shields.io/badge/GitHub-000000?style=for-the-badge&logo=github&logoColor=FFFFFF)](https://github.com/nyte)
...
<p align="center">
  <sub>
    <i>В цифровом мире нет запертых дверей — есть только код, который нужно понять.</i>
  </sub>
  <br>
  <sub>
